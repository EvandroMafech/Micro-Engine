...
export const tileSetSpriteheet_image_path =
  "../public/assets/images/Terrain/Terrain (16x16) vertical.png";
...
export const specialTilesIds = [
  //ids de tiles que são como plataformas (o player pode pular por baixo deles)
  "l6c20",
  "l7c20",
  "l8c20",
  "l6c21",
