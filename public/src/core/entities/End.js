...
import { gameEnd } from "../../editor/ui/interfaceButtons.js";
...
export default class End extends AnimatedImage {
  ...
  checkCollisionWithPlayer() {
    ...
    if (!this.CheckpointActivated && super.checkCollisionWithPlayer()) {
