...
export default class Platform extends AnimatedImage {
  ...
  checkCollisionOnFloor() {
    const playerBottomY =
      player.position.y +
      player.spriteHeight * player.spriteSize -
      player.spriteOffset.bottom * player.spriteSize;
    const playerOffSetBottom =
      player.spriteHeight * player.spriteSize -
      player.spriteOffset.bottom * player.spriteSize;
    const playerLeftX =
      player.position.x + player.spriteOffset.left * player.spriteSize;
    const playerRightX =
      player.position.x +
      player.spriteWidth * player.spriteSize -
      player.spriteOffset.right * player.spriteSize;
