...
function drawGridTilesetCanvas(){
    ...
    for(let c = 0; c < lines; c++){
        for(let l = 0; l <columns ; l++){
            ...
            tileSetCanvasCtx.strokeRect(x,y,tileSizeTilesetCanvas*tileSizeFactor,tileSizeTilesetCanvas*tileSizeFactor) // (x, y, largura, altura)
        }
    }
}
...
function drawTilesetImages(){
        ...
        tileSetCanvasCtx.drawImage(tileSetSpriteSheet,0,0,176*tileSizeFactor,368*tileSizeFactor)
